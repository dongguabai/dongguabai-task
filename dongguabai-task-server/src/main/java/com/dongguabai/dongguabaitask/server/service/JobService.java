package com.dongguabai.dongguabaitask.server.service;

import com.dongguabai.dongguabaitask.server.node.Node;
import com.dongguabai.dongguabaitask.server.persistence.entity.Job;
import com.dongguabai.dongguabaitask.server.persistence.repository.JobMapper;
import com.dongguabai.dongguabaitask.server.util.CronUtils;
...
import static com.dongguabai.dongguabaitask.server.node.NodeManager.TASK_ROOT_PATH;
...
public class JobService {
    ...
    public void execute(Node node) {
        ...
        for (Job job : jobs) {
            try {
                List<String> list = zkClient.getChildren().forPath(TASK_ROOT_PATH + "/" + job.getTaskName());
